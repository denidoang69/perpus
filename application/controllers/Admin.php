...
class Admin extends CI_Controller
{
	...
	function index(){
		...
		$data['buku'] = $this->db->query("select * from anggota order by id_anggota desc limit 10")->result();
	...
	function ganti_password_act(){
		...
		$this->form_validation->set_rules('pass baru','Password Baru','required|matches[ulang_pass]');
	...
	function tambah_buku_act(){
		...
		$judul = $this->input->post('judul-buku');
